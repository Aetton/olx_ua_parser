"""
Django settings for olx_ua_parser project.
...
SECRET_KEY = '+amyjfzben*)i5fcdl)_fsr1w82kza3-ck-y)i^)xb#0tks%k+'
...
ROOT_URLCONF = 'olx_ua_parser.urls'
...
WSGI_APPLICATION = 'olx_ua_parser.wsgi.application'
